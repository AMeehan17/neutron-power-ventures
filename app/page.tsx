        ...
        <div className="container mx-auto px-4 z-10 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="#contact"
                className="bg-neutral-violet hover:bg-neutral-violet/90 text-white px-8 py-4 rounded-full transition-all transform hover:scale-105 font-medium text-lg"
              >
                Contact Us
              </Link>
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-neutral-green hover:bg-neutral-green/90 text-neutral-black px-8 py-4 rounded-full transition-all transform hover:scale-105 font-medium text-lg"
              >
                Schedule a Meeting
              </Link>
            </div>
